<div style="width: 20rem" class="shadow card p-0">
    ...
    <div class="card-body w-100">
        ...
        <h6 style="font-size: 0.9rem; color: rgb(135, 135, 135); font-weight: 300;" class="mb-5">
            Musterstraße 3, Wien 1190
        </h6>
        <div class="d-flex row justify-content-between align-items-end">
            <h6 style="font-size: 0.8rem" class="text-wrap col-4">Geeignet für 2 Personen</h6>
            <div class="row col-8">
