<main class="h-100 d-flex justify-content-center">
    <div style="width: 65%" class="border border-light my-3 p-3 d-flex flex-column">
        ...
        <section class="d-flex flex-column py-4 border-bottom border-light">
            ...
            <h6 style="padding-right: 20%; font-weight: 300" class="h6">
            ...
            <div class="d-flex justify-content-center  gap-5">
                ...
                <div style="width: 14rem" class="d-flex flex-column">
                    <div class="d-flex w-100">
                        ...
                        <h6 style="width: 12rem;" class="alert alert-primary border-start-0 rounded-0">Ausstattung</h6>
                    </div>
                    <div class="d-flex w-100">
